...
export default function Home({ navigation }) {
  // navigation er en prop, der giver adgang til navigation
  return (
    <View style={styles.container}>
      <Image
        source={{
          uri: "https://img.icons8.com/?size=100&id=1zf5ffn5HyB8&format=png&color=000000",
        }}
        style={styles.logo}
      />
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate("Chore List")}
      >
        <Ionicons name="list-outline" size={24} color="#fff" />
        <Text style={styles.buttonText}>See tasklist</Text>
      </TouchableOpacity>
